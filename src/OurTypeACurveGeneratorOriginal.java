...
public class OurTypeACurveGeneratorOriginal implements PairingParametersGenerator {
    protected SecureRandom random;
    protected int rbits;
    protected int qbits;
    protected boolean generateCurveFieldGen;

    public OurTypeACurveGeneratorOriginal(SecureRandom random, int rbits, int qbits, boolean generateCurveFieldGen) {
        this.random = random;
        this.rbits = rbits;
        this.qbits = qbits;
    ...
    public OurTypeACurveGeneratorOriginal(int rbits, int qbits) {
        this(new SecureRandom(), rbits, qbits, false);
    }

    public OurTypeACurveGeneratorOriginal(int rbits, int qbits, boolean generateCurveFieldGen) {
